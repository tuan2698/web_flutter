...
import 'package:demo_web/home/widget/showcase/frame/frame.dart';
import 'package:demo_web/home/widget/showcase/frame/frame_theme.dart';
import 'package:demo_web/home/widget/showcase/showcase.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:timeline_tile/timeline_tile.dart';

import 'showcase/templates/simple_template.dart';
    ...
    return Container(
      ...
      child: Theme(
        data: Theme.of(context).copyWith(
          colorScheme: Theme.of(context).colorScheme.copyWith(secondary: const Color(0xFFFCB69F).withOpacity(0.2)),
        ),
        child: SafeArea(
          child: Scaffold(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.asset(imageUrl,width: 600,height: 300,fit: BoxFit.cover),
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Expanded(
            child: Text(
              'Hành Trình Bên Nhau Của Tâm và Tuấn',
