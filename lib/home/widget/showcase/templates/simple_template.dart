...
class SimpleTemplate extends Template {
  ...
  @override
  Widget builder({required BuildContext context, required TemplateData data,required Widget app}) {
...
class _Link extends StatelessWidget {
  ...
  const _Link({Key? key,required this.data,required this.theme}) : super(key: key);
