...
class DefaultFrameTheme extends InheritedTheme {
  ...
  static DefaultFrameTheme of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<DefaultFrameTheme>() ??
        DefaultFrameTheme.fallback(context);
  }

  static DefaultFrameTheme fallback(BuildContext context) {
    return DefaultFrameTheme(
      data: FrameThemeData(), // Provide default data here
      child: Container(),
    );
  }
